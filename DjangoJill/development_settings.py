# Django settings for DjangoJill project.
...
try:
	...
	SECRET_KEY = 'ytlb!!j_z6v8-$(z43(a9q@1i+7qd3ak+-ia)8n066b4$!cr-r'
...
ROOT_URLCONF = 'DjangoJill.urls'

# Python dotted path to the WSGI application used by Django's runserver.
WSGI_APPLICATION = 'DjangoJill.wsgi.application'
